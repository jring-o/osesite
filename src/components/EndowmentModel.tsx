...
const EndowmentModel = () => {
  return <div className="max-w-[1200px] mx-auto px-4 py-20 md:py-28">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10">
        <div className="flex flex-col items-start bg-card rounded-2xl shadow-lg border border-muted/30 p-0 overflow-hidden hover-lift transition-all h-full">
          ...
          <div className="w-full px-6 pt-6 pb-6 flex flex-col items-start">
            <div className="text-brand-blue font-semibold text-base mb-1">Step 1</div>
            <div className="font-bold text-card-foreground text-lg mb-2 text-left">Donations</div>
        ...
        <div className="flex flex-col items-start bg-card rounded-2xl shadow-lg border border-muted/30 p-0 overflow-hidden hover-lift transition-all h-full">
          ...
          <div className="w-full px-6 pt-6 pb-6 flex flex-col items-start">
            <div className="text-brand-blue font-semibold text-base mb-1">Step 2</div>
            <div className="font-bold text-card-foreground text-lg mb-2 text-left">Investments</div>
        ...
        <div className="flex flex-col items-start bg-card rounded-2xl shadow-lg border border-muted/30 p-0 overflow-hidden hover-lift transition-all h-full">
          ...
          <div className="w-full px-6 pt-6 pb-6 flex flex-col items-start">
            <div className="text-brand-blue font-semibold text-base mb-1">Step 3</div>
            <div className="font-bold text-card-foreground text-lg mb-2 text-left">Selection</div>
            <div className="text-left text-[14px] text-muted-foreground leading-relaxed font-normal">
            A transparent, data-informed processâ€”involving community input, model development, expert oversight, and member votingâ€”identifies and prioritizes critical open source projects for funding. Emphasis is placed on vital infrastructure and high-impact tools.
            </div>
          </div>
        </div>
        <div className="flex flex-col items-start bg-card rounded-2xl shadow-lg border border-muted/30 p-0 overflow-hidden hover-lift transition-all h-full">
          ...
          <div className="w-full px-6 pt-6 pb-6 flex flex-col items-start">
            <div className="text-brand-blue font-semibold text-base mb-1">Step 4</div>
            <div className="font-bold text-card-foreground text-lg mb-2 text-left">Monitoring</div>
            <div className="text-left text-[14px] text-muted-foreground leading-relaxed font-normal">
